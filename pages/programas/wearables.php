<div class="wrapper col3">
    <div id="breadcrumb">
        <ul>
            ...
            <li>&#187;</li>
            <li class="current"><a href="#">Wearables</a>
            </li>
    </div>
</div>
